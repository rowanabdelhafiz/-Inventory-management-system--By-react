...
import { FaUserCircle, FaBox, FaTruck, FaClipboardList, FaSignOutAlt, FaUserPlus } from 'react-icons/fa';
  ...
  return (
    <div className={`sidebar ${menuOpen ? 'open' : ''}`} style={styles.sidebar}>
      ...
      <ul className="sidebar-menu" style={styles.sidebarMenu}>
        ...
        <li onClick={() => handleMenuClick("customerOrders")} style={styles.sidebarMenuItem(activeMenu === "customerOrders")}>
          <FaClipboardList size={20} style={styles.sidebarIcon} />
          <NavLink to="/Customers" style={styles.menuLink}>Customer Orders</NavLink>
        </li>
        <li onClick={() => handleMenuClick("manageEmployees")} style={styles.sidebarMenuItem(activeMenu === "manageEmployees")}>
          <FaUserPlus size={20} style={styles.sidebarIcon} />
          <NavLink to="/ManageEmployees" style={styles.menuLink}>Manage Employees</NavLink>
        </li>
      ...
      <div className="dashboard-panel" style={styles.dashboardPanel}>
        ...
        {activeMenu === "customerOrders" && (
          <div style={styles.dashboardContent}>
            <h2>Customer Orders</h2>
            {/* Add specific content for Customer Orders */}
          </div>
        )}
        {activeMenu === "manageEmployees" && (
          <div style={styles.dashboardContent}>
            <h2>Manage Employees</h2>
            {/* Add specific content for managing employees */}
          </div>
        )}
        {activeMenu === "logout" && (
          <div style={styles.dashboardContent}>
